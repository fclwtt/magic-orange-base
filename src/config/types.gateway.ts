...
export type WideAreaDiscoveryConfig = {
  ...
  enabled?: boolean;
  /** Optional unicast DNS-SD domain (e.g. "mo.internal"). */
  domain?: string;
};
...
export type GatewayControlUiConfig = {
  ...
  enabled?: boolean;
  /** Optional base path prefix for the Control UI (e.g. "/mo"). */
  basePath?: string;
   ...
   * Default off; prefer hosted /__mo__/canvas or /__mo__/a2ui content.
   */
...
export type GatewayTailscaleConfig = {
  ...
  resetOnExit?: boolean;
  /** Optional Tailscale Service name, such as `svc:mo`, for Serve mode. */
  serviceName?: string;
  /**
...
export type GatewayReloadConfig = {
   ...
   * @see https://github.com/mo/mo/issues/65485
   */
...
export type GatewayConfig = {
   ...
   * Env var MO_HANDSHAKE_TIMEOUT_MS takes precedence. Default: 15000.
   */
