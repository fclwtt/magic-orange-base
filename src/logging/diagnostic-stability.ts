...
function getDiagnosticStabilityState(): DiagnosticStabilityState {
  const globalStore = globalThis as typeof globalThis & {
    __moDiagnosticStabilityState?: DiagnosticStabilityState;
  };
  globalStore["__moDiagnosticStabilityState"] ??= createState();
  return globalStore["__moDiagnosticStabilityState"];
}
...
export function resetDiagnosticStabilityRecorderForTest(): void {
  ...
  globalStore["__moDiagnosticStabilityState"] = next;
}
