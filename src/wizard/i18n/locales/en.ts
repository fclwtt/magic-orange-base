...
export const en = {
  ...
  wizard: {
    ...
    migration: {
      ...
      complete: "Migration complete. Run `mo doctor` next.",
    ...
    remote: {
      ...
      insecureRemoteUrl:
        "Use wss:// for remote hosts, or ws://127.0.0.1/localhost via SSH tunnel. Break-glass: MO_ALLOW_INSECURE_PRIVATE_WS=1 for trusted private networks.",
    ...
    skills: {
      ...
      docsLine: "Docs: https://docs.mo.ai/skills",
      enterEnv: "Enter {env}",
    ...
    irc: {
      ...
      nextStatusCommand: "Command: mo channels status --probe",
    ...
    twitch: {
      ...
      envPrompt: "Twitch env var MO_TWITCH_ACCESS_TOKEN detected. Use env token?",
      ...
      helpEnvVars: "Env vars supported: MO_TWITCH_ACCESS_TOKEN",
    ...
    search: {
      ...
      configured: "configured",
      configureLaterHint: "Configure later with mo configure --section web",
      docsLine: "Docs: {url}",
    ...
    finalize: {
      ...
      controlUiDocs: "Docs: https://docs.mo.ai/web/control-ui",
      ...
      gatewayTokenStored:
        "Stored in: $MO_CONFIG_PATH (default: ~/.mo/mo.json) under gateway.auth.token, or in MO_GATEWAY_TOKEN.",
      ...
      securityReminder:
        "Running agents on your computer is risky — harden your setup: https://docs.mo.ai/security",
      ...
      webDocs: "Docs: https://docs.mo.ai/tools/web",
      ...
      whatNow: 'What now: https://mo.ai/showcase ("What People Are Building").',
      whatNowTitle: "What now",
      workspaceBackupTitle: "Workspace backup",
      workspaceDocs: "Docs: https://docs.mo.ai/concepts/agent-workspace",
