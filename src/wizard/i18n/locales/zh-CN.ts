...
export const zh_CN = {
  ...
  wizard: {
    ...
    remote: {
      ...
      insecureRemoteUrl:
        "远程主机请使用 wss://，或通过 SSH 隧道使用 ws://127.0.0.1/localhost。紧急绕过：可信私有网络可设置 MO_ALLOW_INSECURE_PRIVATE_WS=1。",
    ...
    skills: {
      ...
      docsLine: "文档：https://docs.mo.ai/skills",
      enterEnv: "输入 {env}",
    ...
    search: {
      ...
      configured: "已配置",
      configureLaterHint: "稍后可用 mo configure --section web 配置",
      docsLine: "文档：{url}",
    ...
    finalize: {
      ...
      controlUiDocs: "文档：https://docs.mo.ai/web/control-ui",
      ...
      gatewayTokenStored:
        "存储位置：$MO_CONFIG_PATH（默认 ~/.mo/mo.json）中的 gateway.auth.token，或 MO_GATEWAY_TOKEN。",
      ...
      securityReminder:
        "在你的电脑上运行 agent 存在风险，请加固设置：https://docs.mo.ai/security",
      ...
      webDocs: "文档：https://docs.mo.ai/tools/web",
      ...
      workspaceDocs: "文档：https://docs.mo.ai/concepts/agent-workspace",
