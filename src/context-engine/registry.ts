...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("mo.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("mo.contextEngineRegistryState");
