...
const suiteTempDirs = createSuiteTempRootTracker({ prefix: "mo-abort-" });
...
describe("abort detection", () => {
  ...
  it("isAbortRequestText aligns abort command semantics", () => {
    ...
    expect(isAbortRequestText("stop mo!!!")).toBe(true);
    ...
    expect(isAbortRequestText("/stop@mo_bot", { botUsername: "mo_bot" })).toBe(true);
    expect(isAbortRequestText("/Stop@mo_bot", { botUsername: "mo_bot" })).toBe(true);
