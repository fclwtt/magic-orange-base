...
describe("commands registry", () => {
  ...
  it("preserves multiline payloads for skill slash commands", () => {
    ...
    expect(
      normalizeCommandBody("/skill@mo: demo_skill first line\nsecond line", {
        botUsername: "mo",
      }),
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@mo", { botUsername: "mo" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@mo args", {
        botUsername: "mo",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "mo" })).toBe(
      "/help@otherbot",
    );
  });
