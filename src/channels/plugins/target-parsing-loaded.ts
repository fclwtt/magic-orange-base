...
/** @deprecated Use `channelRouteTargetsMatchExact` from `mo/plugin-sdk/channel-route`. */
...
/** @deprecated Use `channelRouteTargetsShareConversation` from `mo/plugin-sdk/channel-route`. */
