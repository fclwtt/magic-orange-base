...
const residue = {
  legacyProfileDir: "/tmp/mo-home/browser/clawd",
  legacyUserDataDir: "/tmp/mo-home/browser/clawd/user-data",
  canonicalUserDataDir: "/tmp/mo-home/browser/mo/user-data",
};
...
describe("browser clawd profile residue health check", () => {
  ...
  it("reports legacy clawd profile residue through doctor lint", async () => {
    ...
    const cfg: OpenClawConfig = { browser: { profiles: { mo: { color: "#FF4500" } } } };
    ...
    const findings = await check.detect({
      ...
      runtime: runtime(),
      cfg,
      configPath: "/tmp/mo-home/mo.json",
    });
