...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when MO_VERSION is not set", async () => {
  ...
  it("prefers MO_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over MO_SERVICE_VERSION when MO_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        MO_VERSION: " ",
        MO_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when MO_VERSION and MO_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        MO_VERSION: " ",
        MO_SERVICE_VERSION: "\t",
