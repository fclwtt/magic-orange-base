...
/**
 * Env var carrying the *effective* update channel into `mo update finalize`
 ...
 * channel split (`MO_UPDATE_POST_CORE_CHANNEL` vs `…_REQUESTED_CHANNEL`).
 */
export const UPDATE_EFFECTIVE_CHANNEL_ENV = "MO_UPDATE_EFFECTIVE_CHANNEL";
