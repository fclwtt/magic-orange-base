...
describe("npm registry spec validation", () => {
  it.each([
    "@mo/voice-call",
    "@mo/voice-call@1.2.3",
    "@mo/voice-call@1.2.3-beta.4",
    "@mo/voice-call@latest",
    "@mo/voice-call@beta",
  ])("accepts %s", (spec) => {
...
describe("npm registry spec parsing helpers", () => {
  it.each([
    ...
    {
      spec: "@mo/voice-call@2026.5.3-1",
      expected: {
        name: "@mo/voice-call",
        raw: "@mo/voice-call@2026.5.3-1",
        selector: "2026.5.3-1",
    ...
    {
      spec: "@mo/voice-call@1.2.3-beta.1",
      expected: {
        name: "@mo/voice-call",
        raw: "@mo/voice-call@1.2.3-beta.1",
  ...
  it.each([
    { spec: "@mo/voice-call", expected: true },
    { spec: "@mo/voice-call@1.2.3", expected: true },
    { spec: "@other/voice-call", expected: false },
    { spec: "voice-call", expected: false },
    { spec: "npm:@mo/voice-call", expected: false },
  ...
  it.each([
    {
      spec: "@mo/voice-call",
      resolvedVersion: "1.2.3-beta.1",
      expected: `Use "@mo/voice-call@beta"`,
    },
    {
      spec: "@mo/voice-call@beta",
      resolvedVersion: "1.2.3-rc.1",
