...
import { readSecretFileSync as readSecretFileSyncImpl } from "@mo/fs-safe/secret";
...
} from "@mo/fs-safe/secret";
export { writeSecretFileAtomic as writePrivateSecretFileAtomic } from "@mo/fs-safe/secret";
