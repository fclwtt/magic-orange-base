...
import { resolveOpenClawPackageRoot, resolveOpenClawPackageRootSync } from "./mo-root.js";
...
export async function resolveControlUiDistIndexPath(
  ...
  // Fallback: traverse up and find package.json with name "mo" + dist/control-ui/index.html
...
export function resolveControlUiRootSync(opts: ControlUiRootResolveOptions = {}): string | null {
  ...
  if (argv1RealpathDir && argv1RealpathDir !== argv1Dir) {
    // Symlinked wrappers (e.g. ~/.bun/bin/mo -> .../dist/index.js)
