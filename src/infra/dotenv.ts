...
const BLOCKED_WORKSPACE_DOTENV_KEYS = new Set([
  ...
  "MO_OAUTH_DIR",
  "MO_PINNED_PYTHON",
  "MO_PINNED_WRITE_PYTHON",
  "MO_PLUGIN_INSTALL_OVERRIDES",
...
const BLOCKED_WORKSPACE_DOTENV_PREFIXES = [
  ...
  // for shell/global config so new MO_* controls are fail-closed by default.
  "MO_",
  "MO_CLAWHUB_",
  "MO_DISABLE_",
  "MO_SKIP_",
...
export function loadDotEnv(opts?: { quiet?: boolean }) {
  ...
  // Then load global fallback: ~/.mo/.env (or MO_STATE_DIR/.env),
