...
/** Resolves OpenClaw's effective home, honoring MO_HOME before OS homes. */
...
/** Resolves the underlying OS user home, ignoring MO_HOME overrides. */
...
/** Resolves a user-supplied path against the OS home, ignoring MO_HOME. */
