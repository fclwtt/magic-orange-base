...
const DEFAULT_VAPID_SUBJECT = "https://mo.ai";
...
function resolveVapidSubjectFromEnv(): string {
  return process.env.MO_VAPID_SUBJECT || DEFAULT_VAPID_SUBJECT;
}

function resolveVapidPublicKeyFromEnv(): string | undefined {
  return process.env.MO_VAPID_PUBLIC_KEY || undefined;
}

function resolveVapidPrivateKeyFromEnv(): string | undefined {
  return process.env.MO_VAPID_PRIVATE_KEY || undefined;
}
