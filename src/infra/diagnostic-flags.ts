...
import { normalizeUniqueStringEntriesLower } from "@mo/normalization-core/string-normalization";
import type { OpenClawConfig } from "../config/types.mo.js";

const DIAGNOSTICS_ENV = "MO_DIAGNOSTICS";
...
/** Resolves enabled diagnostic flags from config plus `MO_DIAGNOSTICS` overrides. */
