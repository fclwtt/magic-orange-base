...
export const LEGACY_MEMORY_LIGHT_DREAMING_EVENT_TEXT = "__mo_memory_core_light_sleep__";
...
export const LEGACY_MEMORY_REM_DREAMING_EVENT_TEXT = "__mo_memory_core_rem_sleep__";
