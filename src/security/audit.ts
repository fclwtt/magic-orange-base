...
import { asNullableRecord } from "@mo/normalization-core/record-coerce";
import {
...
import type { SecurityAuditSuppression } from "../config/types.mo.js";
import {
...
async function materializeAuditGatewayAuthRefs(params: {
  ...
  const materializeParams = {
    ...
    hasTokenCandidate: Boolean(normalizeOptionalString(params.env.MO_GATEWAY_TOKEN)),
    hasPasswordCandidate: Boolean(normalizeOptionalString(params.env.MO_GATEWAY_PASSWORD)),
  };
