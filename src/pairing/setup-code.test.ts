...
describe("pairing setup code", () => {
  ...
  it.each([
    ...
    {
      name: "uses MO_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
  ...
  it.each([
    ...
    },
    {
      ...
      config: {
        gateway: {
          tailscale: { mode: "serve", serviceName: "svc:mo" },
          auth: { mode: "password", password: "secret" },
        },
      } satisfies ResolveSetupConfig,
      expected: {
        authLabel: "password",
        url: "wss://mo.tailnet.ts.net",
        urlSource: "gateway.tailscale.mode=serve",
      },
    },
    {
