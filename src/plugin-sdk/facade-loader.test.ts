...
const FACADE_LOADER_GLOBAL = "__moTestLoadBundledPluginPublicSurfaceModuleSync";
...
describe("plugin-sdk facade loader", () => {
  it("honors trusted bundled plugin dir overrides under the package root", () => {
    const pluginId = nextTrustedPluginId("mo-facade-loader-override-");
    const overrideA = createBundledPluginFixture({
      pluginId,
      kind: "dist",
      prefix: "mo-facade-loader-a-",
      marker: "override-a",
    });
    const overrideB = createBundledPluginFixture({
      pluginId,
      kind: "dist-runtime",
      prefix: "mo-facade-loader-b-",
      marker: "override-b",
    });

    process.env.MO_BUNDLED_PLUGINS_DIR = overrideA.bundledPluginsDir;
    ...
    process.env.MO_BUNDLED_PLUGINS_DIR = overrideB.bundledPluginsDir;
  ...
  it("falls back to package source surfaces when an override dir lacks a bundled plugin", () => {
    const fixture = createPackageSourcePluginFixture({
      prefix: "mo-facade-loader-source-fallback-",
      marker: "source-fallback",
    });
    process.env.MO_BUNDLED_PLUGINS_DIR = createTempDirSync("mo-facade-loader-empty-");
  ...
  it("shares loaded facade ids with facade-runtime", () => {
    const fixture = createBundledPluginFixture({
      prefix: "mo-facade-loader-ids-",
      marker: "identity-check",
    });
    process.env.MO_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
  ...
  it("uses native require for Windows dist facade loads", () => {
    const fixture = createBundledPluginFixture({
      prefix: "mo-facade-loader-windows-",
  ...
  it("breaks circular facade re-entry during module evaluation", () => {
    const fixture = createCircularPluginFixture("mo-facade-loader-circular-");
    process.env.MO_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
  ...
  it("clears the cache on load failure so retries re-execute", () => {
    const fixture = createThrowingPluginFixture("mo-facade-loader-throw-");
    process.env.MO_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
