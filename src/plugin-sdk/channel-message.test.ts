...
describe("defineChannelMessageAdapter", () => {
  const loadPluginSdkSubpaths = async () =>
    await Promise.all([
      import("mo/plugin-sdk/channel-outbound"),
      import("mo/plugin-sdk/channel-message"),
      import("mo/plugin-sdk/channel-message-runtime"),
      import("mo/plugin-sdk/channel-reply-pipeline"),
      import("mo/plugin-sdk/compat"),
    ] as const);
