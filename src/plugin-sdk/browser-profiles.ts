...
export const DEFAULT_MO_BROWSER_ENABLED = true;
...
export const DEFAULT_MO_BROWSER_COLOR = "#FF4500";
/** Default OpenClaw-managed browser profile name. */
export const DEFAULT_MO_BROWSER_PROFILE_NAME = "mo";
/** Default browser profile selected when config omits a profile name. */
export const DEFAULT_BROWSER_DEFAULT_PROFILE_NAME = "mo";
