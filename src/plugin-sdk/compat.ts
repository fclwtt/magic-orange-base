 ...
 * older broad plugin-sdk imports. Use focused mo/plugin-sdk subpaths
 * instead.
 */
...
const shouldWarnCompatImport =
  ...
  process.env.MO_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "mo/plugin-sdk/compat is deprecated for new plugins. Migrate to focused mo/plugin-sdk/<subpath> imports. See https://docs.mo.ai/plugins/sdk-migration",
    {
      code: "MO_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.mo.ai/plugins/sdk-migration",
    },
  );
}
...
/** @deprecated Use `mo/plugin-sdk/channel-outbound`. */
