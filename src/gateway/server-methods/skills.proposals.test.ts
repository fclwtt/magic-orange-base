...
describe("skills proposal gateway handlers", () => {
  beforeEach(async () => {
    testState = await createOpenClawTestState({
      layout: "state-only",
      prefix: "mo-skills-proposals-gateway-state-",
    });
    ...
    mocks.workspaceDir = await tempDirs.make("mo-skills-proposals-gateway-");
  ...
  it("scopes list and inspect to the resolved agent workspace", async () => {
    ...
    const secondWorkspaceDir = await tempDirs.make("mo-skills-proposals-gateway-second-");
