...
describe("resolvePinnedClientMetadata", () => {
  ...
  it.each([
    ["mo-ios", "iOS 26.5.0", "iOS 26.4.2", "iPhone"],
    ["mo-ios", "iPadOS 26.5.0", "iPadOS 26.4.2", "iPad"],
    ["mo-ios", "iPadOS 26.5.0", "iOS 26.4.2", "iPad"],
    ["mo-android", "Android 16", "Android 15", "Android"],
  ])(
