...
export const REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME = "mo_agent_consult";
...
export function buildRealtimeVoiceAgentConsultPolicyInstructions(config: {
  ...
  if (config.consultPolicy === "always") {
    return [
      "Consult behavior:",
      "- Call mo_agent_consult before every substantive answer.",
  ...
  return [
    ...
    "- Call mo_agent_consult before answering requests that need facts, memory, current information, tools, workspace state, or the user's OpenClaw-specific context.",
