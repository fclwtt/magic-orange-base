...
import type { ModelCatalogProvider } from "@mo/model-catalog-core/model-catalog-types";
...
const MO_PROVIDER_INDEX_VERSION = 1;
...
export function normalizeOpenClawProviderIndex(value: unknown): OpenClawProviderIndex | undefined {
  if (!isRecord(value) || value.version !== MO_PROVIDER_INDEX_VERSION) {
    return undefined;
  }
  ...
  return {
    version: MO_PROVIDER_INDEX_VERSION,
