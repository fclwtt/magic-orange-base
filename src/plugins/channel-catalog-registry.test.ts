...
const ENV: NodeJS.ProcessEnv = { HOME: "/tmp/mo-test-home" };
let loadCase = 0;

const RECORDS: Record<string, PluginInstallRecord> = {
  weixin: {
    source: "npm",
    spec: "@tencent-weixin/mo-weixin@2.3.7",
    installPath:
      "/tmp/mo-test-home/.mo/npm/node_modules/@tencent-weixin/mo-weixin",
...
function createChannelCandidate(params: {
  ...
  return {
    ...
    source: "/tmp/mo-test-plugin/index.js",
    rootDir: "/tmp/mo-test-plugin",
    origin: params.origin ?? "global",
    packageName: "@vendor/mo-test-plugin",
    packageManifest: {
