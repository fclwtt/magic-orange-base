...
export const PLUGIN_INSTALL_OVERRIDES_ENV = "MO_PLUGIN_INSTALL_OVERRIDES";
/** Env var gate that must be enabled before install overrides are honored. */
export const ALLOW_PLUGIN_INSTALL_OVERRIDES_ENV = "MO_ALLOW_PLUGIN_INSTALL_OVERRIDES";
