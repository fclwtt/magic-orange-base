    ...
    plugins: [
      {
        ...
        manifestPath: "/tmp/brave/mo.plugin.json",
        channels: [],
        providers: [],
        cliBackends: [],
        syntheticAuthRefs: [],
      ...
      },
      {
        ...
        manifestPath: "/tmp/noise/mo.plugin.json",
        channels: [],
        providers: [],
        cliBackends: [],
        syntheticAuthRefs: [],
...
function createWebSearchManifestRecord(params: {
  ...
  return {
    ...
    manifestPath: `/tmp/${params.id}/mo.plugin.json`,
    channels: [],
    providers: [],
    cliBackends: [],
    syntheticAuthRefs: [],
...
describe("resolvePluginWebSearchProviders", () => {
  ...
  it("resolves current config contents when config changes in place", () => {
    ...
    const env = createWebSearchEnv({ MO_HOME: "/tmp/mo-home-a" });
