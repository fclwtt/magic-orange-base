...
type RuntimeConfigMutationContext = {
  snapshot: import("../../config/types.mo.js").ConfigFileSnapshot;
...
type RuntimeMutateConfigFileParams<T = void> = {
  ...
  mutate: (
    draft: import("../../config/types.mo.js").OpenClawConfig,
    context: RuntimeConfigMutationContext,
  ) => Promise<T | void> | T | void;
};
type RuntimeReplaceConfigFileParams = {
  nextConfig: import("../../config/types.mo.js").OpenClawConfig;
  baseHash?: string;
  afterWrite: RuntimeConfigAfterWrite;
  writeOptions?: RuntimeWriteConfigOptions;
};
...
export type PluginRuntimeCore = {
  ...
  config: {
    ...
    current: () => DeepReadonly<import("../../config/types.mo.js").OpenClawConfig>;
    /**
     ...
     */
    loadConfig: () => import("../../config/types.mo.js").OpenClawConfig;
    /**
     ...
     */
    writeConfigFile: (
      cfg: import("../../config/types.mo.js").OpenClawConfig,
  ...
  media: {
    ...
    detectMime: typeof import("@mo/media-core/mime").detectMime;
    mediaKindFromMime: typeof import("@mo/media-core/constants").mediaKindFromMime;
  ...
  modelAuth: {
    ...
    getApiKeyForModel: (params: {
      model: import("mo/plugin-sdk/llm").Model<import("mo/plugin-sdk/llm").Api>;
      cfg?: import("../../config/types.mo.js").OpenClawConfig;
      workspaceDir?: string;
