...
function vllmPluginWithPackageInstall(): InstalledPluginIndexRecord {
  return {
    pluginId: "vllm",
    origin: "global",
    manifestPath: "/Users/test/.mo/plugins/vllm/mo.plugin.json",
    manifestHash: "hash",
    rootDir: "/Users/test/.mo/plugins/vllm",
    enabled: true,
    startup: {
      sidecar: false,
      memory: false,
    ...
    packageInstall: {
      npm: {
        spec: "@mo/vllm-fork@1.0.0",
        packageName: "@mo/vllm-fork",
        selector: "1.0.0",
...
describe("provider install catalog", () => {
      ...
      plugins: [
        {
          pluginId: "openai",
          origin: "bundled",
          manifestPath: "/repo/extensions/openai/mo.plugin.json",
          manifestHash: "hash",
          ...
          compat: [],
          packageName: "@mo/openai",
          packageInstall: {
            defaultChoice: "npm",
            npm: {
              spec: "@mo/openai@1.2.3",
              packageName: "@mo/openai",
              selector: "1.2.3",
              selectorKind: "exact-version",
              exactVersion: true,
  ...
  it("preserves durable ClawHub install records for provider setup reinstall hints", () => {
    loadPluginRegistrySnapshot.mockReturnValue(
      registrySnapshot({
        installRecords: {
          vllm: {
            source: "clawhub",
            spec: "clawhub:mo/vllm@2026.5.2",
            integrity: "sha256-clawpack",
            clawhubPackage: "mo/vllm",
          },
        },
        plugins: [vllmPluginWithPackageInstall()],
      }),
    ...
    expect(resolveProviderInstallCatalogEntry("vllm")).toEqual({
      ...
      origin: "global",
      install: {
        clawhubSpec: "clawhub:mo/vllm@2026.5.2",
      ...
      plugins: [
        {
          ...
          origin: "global",
          manifestPath: "/Users/test/.mo/plugins/demo-provider/mo.plugin.json",
          manifestHash: "hash",
          rootDir: "/Users/test/.mo/plugins/demo-provider",
          enabled: true,
          startup: {
            sidecar: false,
            memory: false,
      ...
      plugins: [
        {
          pluginId: "demo-provider",
          origin: "workspace",
          manifestPath: "/repo/extensions/demo-provider/mo.plugin.json",
          manifestHash: "hash",
  ...
  it("surfaces provider-index install metadata when the provider plugin is not installed", () => {
    loadOpenClawProviderIndex.mockReturnValue({
      ...
      providers: {
        moonshot: {
          ...
          plugin: {
            id: "moonshot",
            package: "@mo/plugin-moonshot",
            install: {
              npmSpec: "@mo/plugin-moonshot@1.2.3",
              defaultChoice: "npm",
    ...
    expect(resolveProviderInstallCatalogEntry("moonshot-api-key")).toEqual({
      ...
      installSource: {
        defaultChoice: "npm",
        npm: {
          spec: "@mo/plugin-moonshot@1.2.3",
          packageName: "@mo/plugin-moonshot",
          selector: "1.2.3",
          selectorKind: "exact-version",
          exactVersion: true,
          expectedIntegrity: "sha512-moonshot",
  ...
  it("surfaces provider-index ClawHub install metadata as the preferred source", () => {
      ...
      providers: {
        moonshot: {
          ...
          plugin: {
            ...
            package: "@mo/plugin-moonshot",
            install: {
              clawhubSpec: "clawhub:mo/moonshot@2026.5.2",
              npmSpec: "@mo/plugin-moonshot@2026.5.2",
              defaultChoice: "clawhub",
              expectedIntegrity: "sha512-moonshot",
            },
          },
    ...
    expect(resolveProviderInstallCatalogEntry("moonshot-api-key")).toEqual({
      ...
      installSource: {
        defaultChoice: "clawhub",
        clawhub: {
          spec: "clawhub:mo/moonshot@2026.5.2",
          packageName: "mo/moonshot",
          version: "2026.5.2",
          exactVersion: true,
        },
        npm: {
          spec: "@mo/plugin-moonshot@2026.5.2",
          packageName: "@mo/plugin-moonshot",
          selector: "2026.5.2",
          selectorKind: "exact-version",
          exactVersion: true,
      ...
      plugins: [
        {
          pluginId: "moonshot",
          origin: "bundled",
          manifestPath: "/repo/extensions/moonshot/mo.plugin.json",
          manifestHash: "hash",
  ...
  it("keeps missing provider-index entries visible when only some provider plugins are installed", () => {
    ...
    loadOpenClawProviderIndex.mockReturnValue({
      ...
      providers: {
        groq: {
          ...
          plugin: {
            id: "groq",
            package: "@mo/plugin-groq",
            install: {
              npmSpec: "@mo/plugin-groq@1.0.0",
              defaultChoice: "npm",
            },
          },
          authChoices: [
        ...
        vllm: {
          ...
          plugin: {
            id: "vllm",
            package: "@mo/plugin-vllm",
            install: {
              clawhubSpec: "clawhub:mo/vllm@2026.5.2",
              npmSpec: "@mo/plugin-vllm@2026.5.2",
              defaultChoice: "clawhub",
            },
          },
          authChoices: [
    ...
    expect(resolveProviderInstallCatalogEntry("vllm-server")).toEqual({
      ...
      installSource: {
        ...
        npm: {
          spec: "@mo/plugin-vllm@2026.5.2",
          packageName: "@mo/plugin-vllm",
          selector: "2026.5.2",
          selectorKind: "exact-version",
          exactVersion: true,
