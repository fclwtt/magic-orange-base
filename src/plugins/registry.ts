...
function isOfficialCodexPluginRecord(
  ...
  if (record.packageName === "@mo/codex") {
    return true;
  }
  const sourcePath = path
    ...
    .split(path.sep)
    .join("/");
  return sourcePath.includes("/node_modules/@mo/codex");
}
...
const ACTIVE_PLUGIN_HOOK_REGISTRATIONS_KEY = Symbol.for("mo.activePluginHookRegistrations");
