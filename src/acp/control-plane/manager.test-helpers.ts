...
import type { AcpRuntime, AcpRuntimeCapabilities } from "@mo/acp-core/runtime/types";
...
const ORIGINAL_STATE_DIR = process.env.MO_STATE_DIR;
...
export function installAcpSessionManagerTestLifecycle(): void {
  ...
  afterEach(() => {
    if (ORIGINAL_STATE_DIR === undefined) {
      ...
      setTestEnvValue("MO_STATE_DIR", ORIGINAL_STATE_DIR);
    }
