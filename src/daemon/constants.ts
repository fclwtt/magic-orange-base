...
export const GATEWAY_LAUNCH_AGENT_LABEL = "ai.mo.gateway";
export const GATEWAY_SYSTEMD_SERVICE_NAME = "mo-gateway";
export const GATEWAY_WINDOWS_TASK_NAME = "OpenClaw Gateway";
export const GATEWAY_SERVICE_MARKER = "mo";
export const GATEWAY_SERVICE_KIND = "gateway";
export const GATEWAY_SERVICE_RUNTIME_PID_ENV = "MO_GATEWAY_SERVICE_PID";
const NODE_LAUNCH_AGENT_LABEL = "ai.mo.node";
const NODE_SYSTEMD_SERVICE_NAME = "mo-node";
const NODE_WINDOWS_TASK_NAME = "OpenClaw Node";
export const NODE_SERVICE_MARKER = "mo";
...
export function resolveGatewayServiceDescription(params: {
  ...
  return (
    ...
    formatGatewayServiceDescription({
      profile: params.env.MO_PROFILE,
      version: params.environment?.MO_SERVICE_VERSION ?? params.env.MO_SERVICE_VERSION,
    })
  );
}
