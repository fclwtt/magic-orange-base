    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["mo migrate list", "Show available migration providers."],
          ["mo migrate hermes", "Preview Hermes migration, then prompt before applying."],
          ["mo migrate hermes --dry-run", "Preview Hermes migration only."],
          [
            "mo migrate apply hermes --yes",
            "Apply Hermes migration non-interactively after writing a verified backup.",
          ],
          [
            "mo migrate hermes --no-auth-credentials",
