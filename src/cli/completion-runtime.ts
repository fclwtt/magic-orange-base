...
export const COMPLETION_SKIP_PLUGIN_COMMANDS_ENV = "MO_COMPLETION_SKIP_PLUGIN_COMMANDS";
 ...
 * Returns true if profile has `source <(mo completion ...)` instead of cached file.
 */
...
export async function installCompletion(shell: string, yes: boolean, binName = "mo") {
