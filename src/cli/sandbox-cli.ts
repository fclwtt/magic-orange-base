...
const SANDBOX_EXAMPLES = {
  main: [
    ["mo sandbox list", "List all sandbox containers."],
    ["mo sandbox list --browser", "List only browser containers."],
    ["mo sandbox recreate --all", "Recreate all containers."],
    ["mo sandbox recreate --session main", "Recreate a specific session."],
    ["mo sandbox recreate --agent mybot", "Recreate agent containers."],
    ["mo sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["mo sandbox list", "List all sandbox containers."],
    ["mo sandbox list --browser", "List only browser containers."],
    ["mo sandbox list --json", "JSON output."],
  ],
  recreate: [
    ["mo sandbox recreate --all", "Recreate all containers."],
    ["mo sandbox recreate --session main", "Recreate a specific session."],
    ["mo sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["mo sandbox recreate --browser --all", "Recreate only browser containers."],
    ["mo sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["mo sandbox explain", "Show effective sandbox config."],
    ["mo sandbox explain --session agent:main:main", "Explain a specific session."],
    ["mo sandbox explain --agent work", "Explain an agent sandbox."],
    ["mo sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.mo.ai/cli/sandbox")}\n`,
    )
    .action(() => {
