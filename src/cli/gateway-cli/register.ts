      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["mo gateway run", "Run the gateway in the foreground."],
            ["mo gateway status", "Show service status plus connectivity/capability."],
            ["mo gateway discover", "Find local and wide-area gateway beacons."],
            ["mo gateway stability", "Show recent stability diagnostics."],
            ["mo gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.mo.ai/cli/gateway")}\n`,
      ),
  );
