    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["mo directory self --channel slack", "Show the connected account identity."],
          [
            'mo directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["mo directory groups list --channel discord", "List available groups/channels."],
          [
            "mo directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.mo.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
