...
// Candidate scanning only sees mo.json; auth-profile-only surfaces are audited elsewhere.
...
/**
 * Concrete unsupported config value discovered from an mo.json-like object.
 */
...
/**
 * Finds configured mo.json values whose surfaces currently reject SecretRef objects.
 */
