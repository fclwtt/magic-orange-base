...
Main cron => system events for heartbeat. Isolated cron => background task in \`mo tasks\`.
      ...
      return await withGatewayToolCallerIdentity(callerIdentity, async () => {
        switch (action) {
          ...
          case "add": {
            ...
            // See: https://github.com/mo/mo/issues/11310
          ...
          case "wake": {
            ...
            // upstream half of mo/mo#46886 (#64556 — agentId/
