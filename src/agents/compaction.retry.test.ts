...
import type { ExtensionContext } from "mo/plugin-sdk/agent-sessions";
import * as agentSessions from "mo/plugin-sdk/agent-sessions";
import type { AssistantMessage, UserMessage } from "mo/plugin-sdk/llm";
import { afterEach, beforeEach, describe, expect, it, vi } from "vitest";
import { retryAsync } from "../infra/retry.js";

vi.mock("mo/plugin-sdk/agent-sessions", async () => {
  const actual = await vi.importActual<typeof agentSessions>("mo/plugin-sdk/agent-sessions");
  return {
    ...actual,
