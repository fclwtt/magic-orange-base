...
import { testing, createOpenClawTools } from "./mo-tools.js";
...
const mocks = vi.hoisted(() => {
  ...
  return {
    ...
    textToSpeech: vi.fn(async () => ({
      success: true,
      audioPath: "/tmp/mo/tts-config-test.opus",
      provider: "microsoft",
...
vi.mock("./mo-plugin-tools.js", () => ({
  resolveOpenClawPluginToolsForOptions: () => [],
}));

vi.mock("./mo-tools.nodes-workspace-guard.js", () => ({
