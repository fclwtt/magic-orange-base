...
import { readStringValue } from "@mo/normalization-core/string-coerce";
...
const LEGACY_WORKSPACE_STATE_DIRNAME = ".mo";
const LEGACY_WORKSPACE_STATE_FILENAME = "workspace-state.json";
const WORKSPACE_STATE_FILENAME = "mo-workspace-state.json";
...
const WORKSPACE_ATTESTATION_HEADER = "mo-workspace-attestation:v1";
