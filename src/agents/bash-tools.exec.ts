...
import { MO_CLI_ENV_VAR } from "../infra/mo-exec-env.js";
import {
...
const CHANNEL_CONTEXT_ENV_KEY = "MO_CHANNEL_CONTEXT";
...
export function createExecTool(
  ...
  const defaultBackgroundMs = clampWithDefault(
    defaults?.backgroundMs ?? readEnvInt("MO_BASH_YIELD_MS", "PI_BASH_YIELD_MS"),
    10_000,
    10,
    120_000,
  );
