...
export const DEFAULT_SANDBOX_IMAGE = "mo-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "mo-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "mo-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "mo-sandbox-common:bookworm-slim";
...
export const DEFAULT_SANDBOX_BROWSER_PREFIX = "mo-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "mo-sandbox-browser";
