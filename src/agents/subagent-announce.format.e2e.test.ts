...
describe("subagent announce formatting", () => {
  ...
  beforeAll(async () => {
    ...
    // See: https://github.com/mo/mo/issues/31298
    previousFastTestEnv = process.env.MO_TEST_FAST;
  ...
  afterAll(() => {
    ...
    process.env.MO_TEST_FAST = previousFastTestEnv;
  });
  ...
  beforeEach(() => {
    vi.useRealTimers();
    // MO_TEST_FAST is set in beforeAll before module import
