...
describe("tool mutation helpers", () => {
  ...
  it.each([
    ...
    ["exec", "gh search prs --repo mo/mo tool-mutation --json number,title,state"],
    ["bash", "gh pr view 123 --repo mo/mo --json title,state"],
  ...
  it.each([
    ...
    ["exec", "gh api --method POST repos/mo/mo/issues"],
