 ...
 * Encodes cwd into a safe directory name under ~/.mo/agent/sessions/.
 */
...
export class SessionManager {
   ...
   * @param sessionDir Optional session directory. If omitted, uses default (~/.mo/agent/sessions/<encoded-cwd>/).
   */
