...
const DEFAULT_MISSING_TOOL_RESULT_TEXT =
  "[mo] missing tool result in session history; inserted synthetic error result for transcript repair.";
const SYNTHETIC_MISSING_TOOL_RESULT_DETAIL_KEY = "moSyntheticMissingToolResult";
