...
import { lowercasePreservingWhitespace } from "@mo/normalization-core/string-coerce";
      ...
      switch (params.provider) {
        ...
        case "vllm":
          return (
            ...
            'Set VLLM_API_KEY (any value works) or run "mo configure". ' +
            "See: https://docs.mo.ai/providers/vllm"
          );
        default:
          return undefined;
      }
