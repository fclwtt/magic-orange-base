 ...
 */
import type { AcpRuntimeEvent } from "@mo/acp-core/runtime/types";
...
export function runAgentAttempt(params: {
  ...
  const requestedAgentHarnessId = isRawModelRun ? "mo" : undefined;
  ...
  const agentHarnessPolicy = isRawModelRun
    ? ({ runtime: "mo", runtimeSource: "model" } as const)
  ...
  const embeddedAgentHarnessOverride =
    ...
    (agentHarnessPolicy.runtime === "mo" && agentHarnessPolicy.runtimeSource !== "implicit"
      ? "mo"
      : undefined);
