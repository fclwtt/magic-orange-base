...
import type { DB as OpenClawAgentKyselyDatabase } from "../../state/mo-agent-db.generated.js";
import {
  runOpenClawAgentWriteTransaction,
  type OpenClawAgentDatabase,
} from "../../state/mo-agent-db.js";
import { MO_SQLITE_BUSY_TIMEOUT_MS } from "../../state/mo-state-db.js";
...
// The auth database lives in the agent dir and shares the mo-agent schema
...
function resolveAuthProfileDatabaseOptions(agentDir?: string) {
  ...
  return {
    ...
    path: path.join(dir, "mo-agent.sqlite"),
  };
}
