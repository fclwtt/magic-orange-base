...
function getPackageDir(): string {
  ...
  const envDir = process.env.MO_PACKAGE_DIR;
  if (envDir) {
    if (envDir === "~") {
      return homedir();
    }
...
// =============================================================================
// App Config (from package.json moConfig)
// =============================================================================
...
const openClawConfigName: string | undefined = pkg.moConfig?.name;
export const APP_NAME: string = openClawConfigName || "mo";
export const CONFIG_DIR_NAME: string = pkg.moConfig?.configDir || ".mo";
...
// =============================================================================
// User Config Paths (~/.mo/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.mo/agent/) */
