...
describe("provider attribution", () => {
  ...
  it("returns a hidden-spec OpenAI attribution policy", () => {
    expect(resolveProviderAttributionPolicy("openai", { MO_VERSION: "2026.3.22" })).toEqual({
      provider: "openai",
      enabledByDefault: true,
    ...
    expect(
      resolveProviderAttributionPolicy("openai", { MO_VERSION: "2026.3.22" })?.headers,
    ).toEqual({
      originator: "mo",
      version: "2026.3.22",
      "User-Agent": "mo/2026.3.22",
  ...
  it("returns a hidden-spec xAI attribution policy", () => {
    expect(resolveProviderAttributionPolicy("xai", { MO_VERSION: "2026.3.22" })).toEqual({
      provider: "xai",
      enabledByDefault: true,
      verification: "vendor-hidden-api-spec",
      hook: "request-headers",
    ...
    expect(
      resolveProviderAttributionPolicy("xai", { MO_VERSION: "2026.3.22" })?.headers,
    ).toEqual({
      originator: "mo",
      version: "2026.3.22",
      "User-Agent": "mo/2026.3.22",
  ...
  it("lists the current attribution support matrix", () => {
    ...
    expect(
      listProviderAttributionPolicies({ MO_VERSION: "2026.3.22" }).map((policy) => [
        policy.provider,
