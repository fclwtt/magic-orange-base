...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  ...
  const base = {
    ...
    workspaceDir: "/tmp/mo-sandbox",
    agentWorkspaceDir: "/tmp/mo-workspace",
    workspaceAccess: "none",
    runtimeId: "mo-sbx-test",
    runtimeLabel: "mo-sbx-test",
    containerName: "mo-sbx-test",
    ...
    browser: {
      ...
      containerName: "mo-sbx-browser-test",
    },
