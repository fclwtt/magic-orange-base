...
} from "@mo/media-core/inline-image-data-url";
...
const OPENAI_RESPONSES_APIS = new Set([
  ...
  "mo-azure-openai-responses-transport",
]);
...
const ANTHROPIC_REASONING_APIS = new Set([
  ...
  "mo-anthropic-messages-transport",
]);
const OPENAI_COMPLETIONS_APIS = new Set([
  "openai-completions",
  "mo-openai-completions-transport",
]);
...
function isGitHubCopilotResponsesRoute(route: TranscriptAssistantRoute | undefined): boolean {
  return (
    (route?.api === "openai-responses" || route?.api === "mo-openai-responses-transport") &&
...
const OPENAI_REASONING_REPLAY_METADATA_KEY = "__mo_replay";
