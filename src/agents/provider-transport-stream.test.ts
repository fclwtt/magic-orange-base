...
describe("provider transport stream contracts", () => {
    ...
    const cases = [
      {
        ...
        alias: "mo-openai-responses-transport",
      },
      {
      ...
      },
      {
        ...
        alias: "mo-openai-completions-transport",
      },
      {
        ...
        alias: "mo-azure-openai-responses-transport",
      },
      {
        ...
        alias: "mo-anthropic-messages-transport",
      },
      {
        ...
        alias: "mo-google-generative-ai-transport",
  ...
  it("routes localService models through the OpenClaw simple-completion transport", () => {
    ...
    expect(buildTransportAwareSimpleStreamFn(model)).toBeTypeOf("function");
    const preparedModel = prepareTransportAwareSimpleModel(model);
    expect(preparedModel.api).toBe("mo-openai-completions-transport");
