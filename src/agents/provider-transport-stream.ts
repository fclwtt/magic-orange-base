...
const SIMPLE_TRANSPORT_API_ALIAS: Record<string, Api> = {
  "openai-responses": "mo-openai-responses-transport",
  "openai-chatgpt-responses": "mo-openai-responses-transport",
  "openai-completions": "mo-openai-completions-transport",
  "azure-openai-responses": "mo-azure-openai-responses-transport",
  "anthropic-messages": "mo-anthropic-messages-transport",
  "google-generative-ai": "mo-google-generative-ai-transport",
};
