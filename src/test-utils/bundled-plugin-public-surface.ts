...
function findBundledPluginMetadataFast(
  ...
  const rawRoots = [
    ...
    path.resolve(MO_PACKAGE_ROOT, "extensions"),
    path.resolve(MO_PACKAGE_ROOT, "dist-runtime", "extensions"),
    path.resolve(MO_PACKAGE_ROOT, "dist", "extensions"),
