...
export const UPDATE_IN_PROGRESS_ENV = "MO_UPDATE_IN_PROGRESS";
export const UPDATE_POST_CORE_CONVERGENCE_ENV = "MO_UPDATE_POST_CORE_CONVERGENCE";
 ...
 * `MO_UPDATE_IN_PROGRESS` directly (`commands/doctor-update.ts`,
 ...
 * `MO_UPDATE_IN_PROGRESS`, so configured plugin repair must happen now.
 */
