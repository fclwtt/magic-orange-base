...
export const DISABLE_PLUGIN_REGISTRY_MIGRATION_ENV = "MO_DISABLE_PLUGIN_REGISTRY_MIGRATION";
export const FORCE_PLUGIN_REGISTRY_MIGRATION_ENV = "MO_FORCE_PLUGIN_REGISTRY_MIGRATION";
