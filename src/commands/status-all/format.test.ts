...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://mo.local")).toBe("https://mo.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        middleRows: [{ Item: "Security", Value: "Run: mo security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://mo.local" },
      ...
      { Item: "Security", Value: "Run: mo security audit --deep" },
