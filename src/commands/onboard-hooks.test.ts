...
describe("onboard-hooks", () => {
  ...
  describe("setupInternalHooks", () => {
    ...
    it("localizes built-in hook prompts when MO_LOCALE is set", async () => {
      ...
      expect(noteCalls).toEqual([
        [
          [
            ...
            "",
            "Learn more: https://docs.mo.ai/automation/hooks",
          ].join("\n"),
          "Hooks",
        ],
        [
          [
            ...
            "  mo hooks list",
            "  mo hooks enable <name>",
            "  mo hooks disable <name>",
          ].join("\n"),
          "Hooks Configured",
        ],
      ]);
