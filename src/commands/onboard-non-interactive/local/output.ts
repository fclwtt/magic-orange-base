...
function recoveryHintForGatewayHealthFailure(
  ...
  switch (classification) {
    case "auth-mismatch":
      return "Fix: run `mo doctor --fix`.";
    case "module-missing":
      return "Fix: run `mo doctor --fix`.";
    case "service-missing":
      return "Fix: run `mo gateway install --force`.";
    case "service-stopped":
      return "Fix: run `mo gateway restart`.";
    case "startup-blocked":
      return "Fix: run `mo gateway status --deep`.";
    case "not-listening":
      return "Fix: start `mo gateway run`, or run `mo gateway restart` for a managed gateway.";
    default:
      return undefined;
  }
}
