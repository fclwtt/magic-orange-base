  ...
  return {
    ...
    fixHint:
      ...
      (params.issue.status === "expiring"
        ? "Run `mo doctor --fix` to refresh expiring OAuth profiles, or re-authenticate static tokens."
        : "Run `mo doctor --fix` to refresh OAuth profiles, or re-authenticate this provider."),
  };
}
