...
export async function setupCommand(
  ...
  runtime.log(`Next guided path: ${formatCliCommand("mo onboard")}.`);
  runtime.log(
    `Next targeted changes: ${formatCliCommand("mo configure")} for models, channels, Gateway, plugins, skills, and health checks.`,
  );
  runtime.log(`Add a chat channel later: ${formatCliCommand("mo channels add")}.`);
}
