...
export const MIGRATION_SELECTION_ACCEPT = "__mo_migrate_accept_recommended__";
export const MIGRATION_SELECTION_TOGGLE_ALL_ON = "__mo_migrate_toggle_all_on__";
export const MIGRATION_SELECTION_TOGGLE_ALL_OFF = "__mo_migrate_toggle_all_off__";
