...
const debugEmbeddings = isTruthyEnvValue(process.env.MO_DEBUG_MEMORY_EMBEDDINGS);

/** Write embedding debug metadata when MO_DEBUG_MEMORY_EMBEDDINGS is enabled. */
