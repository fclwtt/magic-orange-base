...
import { createSubsystemLogger, redactSensitiveText } from "./mo-runtime-io.js";
import {
  HEARTBEAT_PROMPT,
  HEARTBEAT_TOKEN,
...
function isDreamingNarrativeBootstrapRecord(record: unknown): boolean {
  ...
  if (
    ...
    candidate.customType !== "mo:bootstrap-context:full" ||
    !candidate.data ||
 ...
 * impossible.
 *
 * See: https://github.com/mo/mo/issues/63921
 */
