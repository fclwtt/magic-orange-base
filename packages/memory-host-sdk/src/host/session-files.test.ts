...
import { clearConfigCache, clearRuntimeConfigSnapshot } from "./mo-runtime-session.js";
import {
  buildSessionEntry,
...
beforeEach(() => {
  ...
  Reflect.set(process.env, "MO_STATE_DIR", tmpDir);
...
describe("buildSessionEntry", () => {
  it("returns lineMap tracking original JSONL line numbers", async () => {
    ...
    const jsonlLines = [
      ...
      JSON.stringify({ type: "custom", customType: "mo.cache-ttl", data: {} }),
