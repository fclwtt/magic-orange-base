...
import { resolveChannelTtsVoiceDelivery } from "mo/plugin-sdk/channel-targets";
import type {
  OpenClawConfig,
  ResolvedTtsPersona,
  TtsAutoMode,
...
import { transcodeAudioBuffer } from "mo/plugin-sdk/media-runtime";
import { clampTimerTimeoutMs } from "mo/plugin-sdk/number-runtime";
import {
...
import { isVerbose, logVerbose } from "mo/plugin-sdk/runtime-env";
import { tempWorkspaceSync, resolvePreferredOpenClawTmpDir } from "mo/plugin-sdk/sandbox";
import { privateFileStoreSync } from "mo/plugin-sdk/security-runtime";
import {
  normalizeLowercaseStringOrEmpty,
  normalizeOptionalLowercaseString,
  normalizeOptionalString,
} from "mo/plugin-sdk/string-coerce-runtime";
import { stripMarkdown } from "mo/plugin-sdk/text-chunking";
import { resolveConfigDir, resolveUserPath } from "mo/plugin-sdk/text-utility-runtime";
import {
...
function resolveTtsPrefsPathValue(prefsPath: string | undefined): string {
  ...
  const envPath = process.env.MO_TTS_PREFS?.trim();
  if (envPath) {
