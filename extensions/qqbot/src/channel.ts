...
import { getExecApprovalReplyMetadata } from "mo/plugin-sdk/approval-runtime";
import {
...
export const qqbotPlugin: ChannelPlugin<ResolvedQQBotAccount> = {
  ...
  gateway: {
    startAccount: async (ctx) => {
      ...
      // mo.json). We only restore when both fields are empty so a
      ...
      await startGateway({
        ...
        onReady: () => {
          ...
          // upgrade that might wipe mo.json mid-flight.
