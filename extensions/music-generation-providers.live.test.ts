...
const providerFilter = parseCsvFilter(process.env.MO_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.MO_LIVE_MUSIC_GENERATION_MODELS);
