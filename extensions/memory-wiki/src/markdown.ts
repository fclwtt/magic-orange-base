...
export const WIKI_RELATED_START_MARKER = "<!-- mo:wiki:related:start -->";
export const WIKI_RELATED_END_MARKER = "<!-- mo:wiki:related:end -->";
export const WIKI_RAW_SOURCE_MARKER = "<!-- mo:wiki:raw-source -->";
...
const HUMAN_START_MARKER = "<!-- mo:human:start -->";
const HUMAN_END_MARKER = "<!-- mo:human:end -->";
