...
import { readFiniteNumberParam } from "mo/plugin-sdk/param-readers";
...
const GENERATED_START = "<!-- mo:wiki:generated:start -->";
const GENERATED_END = "<!-- mo:wiki:generated:end -->";
const HUMAN_START = "<!-- mo:human:start -->";
const HUMAN_END = "<!-- mo:human:end -->";
