...
vi.mock("mo/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
  matchesMentionPatterns: () => false,
}));
vi.mock("mo/plugin-sdk/channel-pairing", () => ({
...
vi.mock("mo/plugin-sdk/command-auth-native", () => ({
...
vi.mock("mo/plugin-sdk/runtime-group-policy", () => ({
...
vi.mock("mo/plugin-sdk/reply-history", () => ({
...
describe("handleLineWebhookEvents", () => {
  ...
  afterAll(() => {
    vi.doUnmock("mo/plugin-sdk/channel-inbound");
    vi.doUnmock("mo/plugin-sdk/channel-pairing");
    vi.doUnmock("mo/plugin-sdk/command-auth-native");
    vi.doUnmock("mo/plugin-sdk/runtime-group-policy");
    vi.doUnmock("mo/plugin-sdk/runtime-env");
    vi.doUnmock("mo/plugin-sdk/reply-history");
    vi.doUnmock("mo/plugin-sdk/routing");
    vi.doUnmock("mo/plugin-sdk/conversation-runtime");
