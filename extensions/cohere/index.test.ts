...
import { registerSingleProviderPlugin } from "mo/plugin-sdk/plugin-test-runtime";
import { buildOpenAICompletionsParams } from "mo/plugin-sdk/provider-transport-runtime";
...
function readManifest() {
  return JSON.parse(readFileSync(new URL("./mo.plugin.json", import.meta.url), "utf8")) as {
