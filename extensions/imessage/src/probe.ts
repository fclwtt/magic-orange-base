...
import type { BaseProbeResult } from "mo/plugin-sdk/channel-contract";
import {
  asDateTimestampMs,
  resolveExpiresAtMsFromDurationMs,
} from "mo/plugin-sdk/number-runtime";
import { runCommandWithTimeout } from "mo/plugin-sdk/process-runtime";
import { getRuntimeConfig } from "mo/plugin-sdk/runtime-config-snapshot";
import type { RuntimeEnv } from "mo/plugin-sdk/runtime-env";
import { detectBinary } from "mo/plugin-sdk/setup";
import {
...
// subcommand (added by mo/imsg#114, which lets a single bridge call
...
export async function probeIMessagePrivateApi(
  ...
  try {
    ...
    // mo/imsg#114. We do this even when the bridge is unavailable
