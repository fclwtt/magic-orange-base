...
import {
  ...
  type OpenClawConfig,
} from "mo/plugin-sdk/account-resolution";
import { resolveAccountEntry } from "mo/plugin-sdk/routing";
...
// caused duplicate inbound handling in mo/mo#65141.
...
function resolveIMessageAccountSourceOwner(params: {
  ...
  // bindings tied to the named account keep working (mo/mo#65141).
 ...
 * watchers (mo/mo#65141) without otherwise marking the duplicate
