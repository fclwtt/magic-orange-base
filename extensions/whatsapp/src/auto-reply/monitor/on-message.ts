...
import type { AckReactionHandle } from "mo/plugin-sdk/channel-feedback";
import type { OpenClawConfig } from "mo/plugin-sdk/config-contracts";
import {
  ensureConfiguredBindingRouteReady,
  resolveConfiguredBindingRoute,
} from "mo/plugin-sdk/conversation-binding-runtime";
import type { getReplyFromConfig } from "mo/plugin-sdk/reply-runtime";
import type { MsgContext } from "mo/plugin-sdk/reply-runtime";
import { resolveAgentRoute } from "mo/plugin-sdk/routing";
import { buildGroupHistoryKey } from "mo/plugin-sdk/routing";
...
export function createWebOnMessageHandler(params: {
  ...
  replyLogger: ReturnType<(typeof import("mo/plugin-sdk/runtime-env"))["getChildLogger"]>;
