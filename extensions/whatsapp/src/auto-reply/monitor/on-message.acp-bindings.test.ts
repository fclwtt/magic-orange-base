...
import type { ConfiguredBindingRouteResult } from "mo/plugin-sdk/conversation-binding-runtime";
...
vi.mock("mo/plugin-sdk/conversation-binding-runtime", () => ({
...
vi.mock("mo/plugin-sdk/routing", async (importOriginal) => {
  const actual = await importOriginal<typeof import("mo/plugin-sdk/routing")>();
  return {
    ...actual,
