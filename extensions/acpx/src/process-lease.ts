...
export const MO_ACPX_LEASE_ID_ENV = "MO_ACPX_LEASE_ID";
/** Environment variable carrying the owning gateway instance id. */
export const MO_GATEWAY_INSTANCE_ID_ENV = "MO_GATEWAY_INSTANCE_ID";
/** CLI argument carrying the ACPX process lease id for platforms without env wrapping. */
export const MO_ACPX_LEASE_ID_ARG = "--mo-acpx-lease-id";
/** CLI argument carrying the owning gateway instance id. */
export const MO_GATEWAY_INSTANCE_ID_ARG = "--mo-gateway-instance-id";
...
export function withAcpxLeaseEnvironment(params: {
  ...
  return [
    "env",
    `${MO_ACPX_LEASE_ID_ENV}=${quoteEnvValue(params.leaseId)}`,
    `${MO_GATEWAY_INSTANCE_ID_ENV}=${quoteEnvValue(params.gatewayInstanceId)}`,
