...
import type { getSessionEntry as getSessionEntryType } from "mo/plugin-sdk/session-store-runtime";
...
vi.mock("mo/plugin-sdk/session-store-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("mo/plugin-sdk/session-store-runtime")>();
  return {
    ...actual,
