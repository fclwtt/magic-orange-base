...
import { resolveAgentDir } from "mo/plugin-sdk/agent-runtime";
import { isToolAllowed } from "mo/plugin-sdk/sandbox";
...
type OpenClawCodingToolsOptions = NonNullable<
  Parameters<(typeof import("mo/plugin-sdk/agent-harness"))["createOpenClawCodingTools"]>[0]
>;
...
export type OpenClawCodingToolsFactory =
  (typeof import("mo/plugin-sdk/agent-harness"))["createOpenClawCodingTools"];
...
export async function buildDynamicTools(input: DynamicToolBuildParams) {
  ...
  const agentHarness = await import("mo/plugin-sdk/agent-harness");
  ...
  toolBuildStages.mark("create-mo-coding-tools");
