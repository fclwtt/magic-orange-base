...
import { emitTrustedDiagnosticEvent } from "mo/plugin-sdk/diagnostic-runtime";
import type { ImageContent, TextContent } from "mo/plugin-sdk/llm";
...
export const CODEX_MO_DYNAMIC_TOOL_NAMESPACE = "mo";
...
function createCodexDynamicToolSpecs(params: {
  ...
  if (namespaceTools.length > 0) {
    specs.push({
      type: "namespace",
      name: CODEX_MO_DYNAMIC_TOOL_NAMESPACE,
      description: "",
