...
import { registerSandboxBackend } from "mo/plugin-sdk/sandbox";
...
describe("runCodexAppServerAttempt context-engine lifecycle", () => {
  beforeEach(async () => {
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "mo-codex-context-engine-"));
  });
