...
type GetRuntimeConfigFn =
  typeof import("mo/plugin-sdk/runtime-config-snapshot").getRuntimeConfig;
type GetSessionEntryFn = typeof import("mo/plugin-sdk/session-store-runtime").getSessionEntry;
type ListSessionEntriesFn =
  typeof import("mo/plugin-sdk/session-store-runtime").listSessionEntries;
type LoadSessionStoreFn =
  typeof import("mo/plugin-sdk/session-store-runtime").loadSessionStore;
type ResolveStorePathFn =
  typeof import("mo/plugin-sdk/session-store-runtime").resolveStorePath;
type ReadSessionUpdatedAtFn =
  typeof import("mo/plugin-sdk/session-store-runtime").readSessionUpdatedAt;
...
const { sessionStorePath } = vi.hoisted(() => {
  ...
  return {
    sessionStorePath: `${tempRoot.replace(/[\\/]+$/u, "")}${separator}mo-telegram-${
      process.pid
...
vi.mock("mo/plugin-sdk/web-media", () => ({
  loadWebMedia,
}));
