...
import { resolveApiKeyForProvider } from "mo/plugin-sdk/agent-runtime";
import type { ModelCatalogEntry } from "mo/plugin-sdk/agent-runtime";
import {
  findModelInCatalog,
  loadModelCatalog,
  modelSupportsVision,
} from "mo/plugin-sdk/agent-runtime";
import { resolveDefaultModelForAgent } from "mo/plugin-sdk/agent-runtime";
import type { OpenClawConfig } from "mo/plugin-sdk/config-contracts";
import { resolveAutoImageModel } from "mo/plugin-sdk/media-runtime";
import {
