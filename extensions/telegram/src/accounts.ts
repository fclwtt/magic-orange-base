...
import {
  ...
  type OpenClawConfig,
} from "mo/plugin-sdk/account-core";
import type {
  TelegramAccountConfig,
  TelegramActionConfig,
} from "mo/plugin-sdk/config-contracts";
import { formatSetExplicitDefaultInstruction } from "mo/plugin-sdk/routing";
import { createSubsystemLogger, isTruthyEnvValue } from "mo/plugin-sdk/runtime-env";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.MO_DEBUG_TELEGRAM_ACCOUNTS)) {
