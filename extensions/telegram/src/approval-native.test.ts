...
import { saveSessionStore, type SessionEntry } from "mo/plugin-sdk/session-store-runtime";
...
const STORE_PATH = path.join(os.tmpdir(), "mo-telegram-approval-native-test.json");
