...
} from "mo/plugin-sdk/proxy-capture";
import { resolveRequestUrl } from "mo/plugin-sdk/request-url";
...
// fix for the leak observed in mo#68128 is the transport lifecycle that
...
function resolveOpenClawProxyUrlForTelegram(
  ...
  const proxyUrl = env.MO_PROXY_URL?.trim();
