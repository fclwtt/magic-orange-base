...
import { resolveAccountWithDefaultFallback } from "mo/plugin-sdk/account-core";
import { tryReadSecretFileSync } from "mo/plugin-sdk/channel-core";
import type { OpenClawConfig } from "mo/plugin-sdk/config-contracts";
import type { TelegramAccountConfig } from "mo/plugin-sdk/config-contracts";
import { resolveDefaultSecretProviderAlias } from "mo/plugin-sdk/provider-auth";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "mo/plugin-sdk/routing";
import {
  hasConfiguredSecretInput,
  normalizeSecretInputString,
} from "mo/plugin-sdk/secret-input";
import { coerceSecretRef } from "mo/plugin-sdk/secret-input-runtime";
import { FsSafeError } from "mo/plugin-sdk/security-runtime";
