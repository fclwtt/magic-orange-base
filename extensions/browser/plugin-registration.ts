...
const EAGER_BROWSER_CONTROL_SERVICE_ENV = "MO_EAGER_BROWSER_CONTROL_SERVER";
...
function createLazyBrowserTool(opts?: {
  ...
  return {
    ...
    description: [
      ...
      "Browser choice: omit profile by default for the isolated OpenClaw-managed browser (`mo`).",
