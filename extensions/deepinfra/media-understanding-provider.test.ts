...
} from "mo/plugin-sdk/media-understanding";
...
vi.mock("mo/plugin-sdk/media-understanding", async () => {
  const actual = await vi.importActual<typeof import("mo/plugin-sdk/media-understanding")>(
    "mo/plugin-sdk/media-understanding",
  );
  return {
    ...actual,
...
afterAll(() => {
  vi.doUnmock("mo/plugin-sdk/media-understanding");
  vi.resetModules();
});
