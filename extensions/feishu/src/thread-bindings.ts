...
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "mo/plugin-sdk/routing";
...
const FEISHU_THREAD_BINDINGS_STATE_KEY = Symbol.for("mo.feishuThreadBindingsState");
