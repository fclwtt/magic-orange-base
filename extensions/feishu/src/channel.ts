...
import { describeAccountSnapshot } from "mo/plugin-sdk/account-helpers";
import { formatAllowFromLowercase } from "mo/plugin-sdk/allow-from";
import {
...
import { createChatChannelPlugin } from "mo/plugin-sdk/channel-core";
import {
...
import { createPairingPrefixStripper } from "mo/plugin-sdk/channel-pairing";
import {
  createAllowlistProviderGroupPolicyWarningCollector,
  projectConfigAccountIdWarningCollector,
} from "mo/plugin-sdk/channel-policy";
import { getSessionBindingService } from "mo/plugin-sdk/conversation-runtime";
import {
  createChannelDirectoryAdapter,
  createRuntimeDirectoryLiveAdapter,
} from "mo/plugin-sdk/directory-runtime";
import { normalizeMessagePresentation } from "mo/plugin-sdk/interactive-runtime";
...
import { createComputedAccountStatusAdapter } from "mo/plugin-sdk/status-helpers";
...
export const feishuPlugin: ChannelPlugin<ResolvedFeishuAccount, FeishuProbeResult> =
  createChatChannelPlugin({
    base: {
      ...
      auth: {
        login: async ({ cfg }) => {
          const { createClackPrompter } = await import("mo/plugin-sdk/setup-runtime");
          const { replaceConfigFile } = await import("mo/plugin-sdk/config-mutation");
