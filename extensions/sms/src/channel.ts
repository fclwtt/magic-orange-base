...
import { createConditionalWarningCollector } from "mo/plugin-sdk/channel-policy";
import { createEmptyChannelDirectoryAdapter } from "mo/plugin-sdk/directory-runtime";
...
const resolveSmsDmPolicy = createScopedDmSecurityResolver<ResolvedSmsAccount>({
  ...
  approveHint: "mo pairing approve sms <code>",
