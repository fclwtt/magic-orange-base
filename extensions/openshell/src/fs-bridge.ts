...
import { root as fsRoot } from "mo/plugin-sdk/file-access-runtime";
import type {
  SandboxFsBridge,
  SandboxFsStat,
  SandboxResolvedPath,
} from "mo/plugin-sdk/sandbox";
import { createWritableRenameTargetResolver } from "mo/plugin-sdk/sandbox";
import { FsSafeError, isPathInside } from "mo/plugin-sdk/security-runtime";
...
const MATERIALIZED_SKILLS_CONTAINER_PARTS = [".mo", "sandbox-skills", "skills"] as const;
