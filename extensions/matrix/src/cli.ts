...
import { parseStrictInteger, timestampMsToIsoString } from "mo/plugin-sdk/number-runtime";
import type { ChannelSetupInput } from "mo/plugin-sdk/setup";
...
export function registerMatrixCli(params: { program: Command }): void {
  const root = params.program
    ...
    .addHelpText("after", () => "\nDocs: https://docs.mo.ai/channels/matrix\n");
      ...
      async (options: {
        ...
        await runMatrixCliCommand({
          ...
          onText: (result) => {
            ...
            const bindHint = `mo agents bind --agent <id> --bind matrix:${result.accountId}`;
