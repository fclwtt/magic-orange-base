...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/mo-matrix-create-client-test",
    storagePath: "/tmp/mo-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/mo-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/mo-matrix-create-client-test/idb.snapshot",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "mo-matrix-default-token-hash",
