...
import { hasFinalInboundReplyDispatch } from "mo/plugin-sdk/channel-inbound";
import type { ChannelBotLoopProtectionFacts } from "mo/plugin-sdk/channel-inbound";
import {
...
import { isDangerousNameMatchingEnabled } from "mo/plugin-sdk/dangerous-name-runtime";
import {
  isFutureDateTimestampMs,
  resolveExpiresAtMsFromDurationMs,
} from "mo/plugin-sdk/number-runtime";
import { mergePairLoopGuardConfig } from "mo/plugin-sdk/pair-loop-guard-runtime";
import { buildInboundHistoryFromEntries } from "mo/plugin-sdk/reply-history";
import {
  buildTtsSupplementMediaPayload,
  getReplyPayloadTtsSupplement,
} from "mo/plugin-sdk/reply-payload";
import type { GetReplyOptions } from "mo/plugin-sdk/reply-runtime";
...
import { getSessionEntry } from "mo/plugin-sdk/session-store-runtime";
...
import { MATRIX_MO_FINALIZED_PREVIEW_KEY } from "../send/types.js";
...
let acpBindingRuntimePromise:
  | Promise<typeof import("mo/plugin-sdk/acp-binding-runtime")>
  | undefined;
let sessionBindingRuntimePromise:
  | Promise<typeof import("mo/plugin-sdk/session-binding-runtime")>
  | undefined;
...
function loadAcpBindingRuntime(): Promise<
  typeof import("mo/plugin-sdk/acp-binding-runtime")
> {
  acpBindingRuntimePromise ??= import("mo/plugin-sdk/acp-binding-runtime");
  return acpBindingRuntimePromise;
}

function loadSessionBindingRuntime(): Promise<
  typeof import("mo/plugin-sdk/session-binding-runtime")
> {
  sessionBindingRuntimePromise ??= import("mo/plugin-sdk/session-binding-runtime");
...
function buildMatrixFinalizedPreviewContent(): Record<string, unknown> {
  return { [MATRIX_MO_FINALIZED_PREVIEW_KEY]: true };
}
