...
import { resolveConfiguredAcpBindingRecord } from "mo/plugin-sdk/acp-binding-resolve-runtime";
...
import { getSessionBindingService } from "mo/plugin-sdk/session-binding-runtime";
