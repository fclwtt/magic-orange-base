 ...
 */
import { lowercasePreservingWhitespace } from "mo/plugin-sdk/string-coerce-runtime";

/** Hosted path prefix for bundled A2UI assets. */
export const A2UI_PATH = "/__mo__/a2ui";

/** Hosted path prefix for Canvas document/static assets. */
export const CANVAS_HOST_PATH = "/__mo__/canvas";

/** Hosted WebSocket path for Canvas live reload. */
export const CANVAS_WS_PATH = "/__mo__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.moCanvasA2UIAction.postMessage(...)
  // - Android: window.moCanvasA2UIAction.postMessage(...)
  const handlerNames = ["moCanvasA2UIAction"];
  ...
  globalThis.moPostMessage = postToNode;
  globalThis.moSendUserAction = sendUserAction;
