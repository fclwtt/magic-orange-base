...
import { withStateDirEnv } from "mo/plugin-sdk/test-env";
...
describe("canvas host state dir defaults", () => {
  ...
  it("uses MO_STATE_DIR for the default canvas root", async () => {
    await withStateDirEnv("mo-canvas-state-", async ({ stateDir }) => {
