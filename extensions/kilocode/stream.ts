...
import { resolveProviderRequestHeaders } from "mo/plugin-sdk/provider-http";
import { normalizeOpenAICompatibleReasoningPayload } from "mo/plugin-sdk/provider-stream-shared";
import { normalizeOptionalLowercaseString } from "mo/plugin-sdk/string-coerce-runtime";

const KILOCODE_FEATURE_HEADER = "X-KILOCODE-FEATURE";
const KILOCODE_FEATURE_DEFAULT = "mo";
