...
import { formatInboundEnvelope } from "mo/plugin-sdk/channel-inbound";
import { runTasksWithConcurrency } from "mo/plugin-sdk/concurrency-runtime";
import type { ContextVisibilityMode, OpenClawConfig } from "mo/plugin-sdk/config-contracts";
import { logVerbose } from "mo/plugin-sdk/runtime-env";
import {
  filterSupplementalContextItems,
  shouldIncludeSupplementalContext,
} from "mo/plugin-sdk/security-runtime";
...
export async function resolveSlackThreadContextData(params: {
  ...
  envelopeOptions: ReturnType<
    typeof import("mo/plugin-sdk/channel-inbound").resolveEnvelopeFormatOptions
  >;
