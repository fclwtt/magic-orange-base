...
import { resolveDefaultAgentId } from "mo/plugin-sdk/agent-runtime";
import { formatAllowlistMatchMeta } from "mo/plugin-sdk/allow-from";
import type { ChannelRuntimeSurface } from "mo/plugin-sdk/channel-contract";
import type {
  OpenClawConfig,
  SlackReactionNotificationMode,
} from "mo/plugin-sdk/config-contracts";
import type { SessionScope } from "mo/plugin-sdk/config-contracts";
import type { DmPolicy, GroupPolicy } from "mo/plugin-sdk/config-contracts";
import { resolveRuntimeConversationBindingRoute } from "mo/plugin-sdk/conversation-runtime";
import { createDedupeCache } from "mo/plugin-sdk/dedupe-runtime";
import type { HistoryEntry } from "mo/plugin-sdk/reply-history";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("mo/plugin-sdk/config-contracts").SlackSlashCommandConfig>;
  textLimit: number;
