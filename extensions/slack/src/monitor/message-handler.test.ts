...
vi.mock("mo/plugin-sdk/channel-inbound", async () => {
  const actual = await vi.importActual<typeof import("mo/plugin-sdk/channel-inbound")>(
    "mo/plugin-sdk/channel-inbound",
  );
  return {
    ...actual,
