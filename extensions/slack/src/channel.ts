...
} from "mo/plugin-sdk/allowlist-config-edit";
import { adaptScopedAccountAccessor } from "mo/plugin-sdk/channel-config-helpers";
import {
  buildThreadAwareOutboundSessionRoute,
  createChatChannelPlugin,
} from "mo/plugin-sdk/channel-core";
import { createChannelMessageAdapterFromOutbound } from "mo/plugin-sdk/channel-outbound";
...
} from "mo/plugin-sdk/channel-send-result";
import {
  createChannelDirectoryAdapter,
  createRuntimeDirectoryLiveAdapter,
} from "mo/plugin-sdk/directory-runtime";
import { createLazyRuntimeModule } from "mo/plugin-sdk/lazy-runtime";
import { buildOutboundBaseSessionKey, type RoutePeer } from "mo/plugin-sdk/routing";
import {
...
import { sanitizeAssistantVisibleText } from "mo/plugin-sdk/text-chunking";
import {
...
//
// `mo/plugin-sdk/channel-policy` is intentionally NOT lazy here —
...
const EXTENSION_SHARED_MODULE_ID = "mo/plugin-sdk/extension-shared";
const TARGET_RESOLVER_RUNTIME_MODULE_ID = "mo/plugin-sdk/target-resolver-runtime";
