...
vi.mock("mo/plugin-sdk/provider-web-search", () => ({
...
describe("tavily client X-Client-Source header", () => {
  ...
  it("runTavilySearch sends X-Client-Source: mo", async () => {
    ...
    expect(params.extraHeaders).toEqual({ "X-Client-Source": "mo" });
  });
  ...
  it("runTavilyExtract sends X-Client-Source: mo", async () => {
