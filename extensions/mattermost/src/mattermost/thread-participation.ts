...
import { resolveGlobalDedupeCache } from "mo/plugin-sdk/dedupe-runtime";
 ...
 */
const MATTERMOST_THREAD_PARTICIPATION_KEY = Symbol.for("mo.mattermostThreadParticipation");
