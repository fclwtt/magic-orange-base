...
const MO_FALLBACK_MODEL_MAX_TOKENS = new Set([4096, 8192, 16_384]);
...
function resolveAdaptiveBedrockMaxTokens(
  ...
  return MO_FALLBACK_MODEL_MAX_TOKENS.has(model.maxTokens) ? undefined : model.maxTokens;
}
 ...
 * Defaults to "short" and uses MO_CACHE_RETENTION for backward compatibility.
 */
