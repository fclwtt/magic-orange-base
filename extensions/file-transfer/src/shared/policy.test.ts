...
vi.mock("mo/plugin-sdk/config-mutation", () => ({
...
afterAll(() => {
  vi.doUnmock("mo/plugin-sdk/runtime-config-snapshot");
  vi.doUnmock("mo/plugin-sdk/config-mutation");
  vi.resetModules();
});
