...
const LEFT: HarnessVariant = { id: "left", label: "Left", runtime: "mo" };
const RIGHT: HarnessVariant = { id: "right", label: "Right", runtime: "mo" };
