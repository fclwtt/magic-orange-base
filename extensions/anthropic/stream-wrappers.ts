...
const MO_DEFAULT_ANTHROPIC_BETAS = [
  "fine-grained-tool-streaming-2025-05-14",
  "interleaved-thinking-2025-05-14",
] as const;
const MO_OAUTH_ANTHROPIC_BETAS = [
  "claude-code-20250219",
  "oauth-2025-04-20",
  ...MO_DEFAULT_ANTHROPIC_BETAS,
] as const;
...
export function createAnthropicBetaHeadersWrapper(
  ...
  return (model, context, options) => {
    ...
    const openClawBetas = isOauth
      ? (MO_OAUTH_ANTHROPIC_BETAS as readonly string[])
      : (MO_DEFAULT_ANTHROPIC_BETAS as readonly string[]);
