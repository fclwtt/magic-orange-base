...
import type { ModelDefinitionConfig } from "mo/plugin-sdk/provider-onboard";
import { withFetchPreconnect } from "mo/plugin-sdk/test-env";
...
describe("Ollama provider", () => {
  const createAgentDir = () => mkdtempSync(join(tmpdir(), "mo-test-"));
