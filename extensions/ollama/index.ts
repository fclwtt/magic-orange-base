...
import { collectConfiguredModelRefValues } from "@mo/model-catalog-core/configured-model-refs";
import type { OpenClawConfig } from "mo/plugin-sdk/config-contracts";
import { resolvePluginConfigObject } from "mo/plugin-sdk/plugin-config-runtime";
import {
  definePluginEntry,
  ...
  register(api: OpenClawPluginApi) {
    ...
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set OLLAMA_API_KEY or run "mo onboard --auth-choice ollama-cloud". ' +
        "See: https://docs.mo.ai/providers/ollama",
    });
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "mo configure". ' +
        "See: https://docs.mo.ai/providers/ollama",
    });
  },
});
