...
import { extractNonEmptyAssistantText, isLiveTestEnabled } from "mo/plugin-sdk/test-env";
...
const LIVE_MODEL_ID =
  process.env.MO_LIVE_OPENCODE_DEEPSEEK_MODEL?.trim() || "deepseek-v4-flash-free";
