...
import { isRecord, normalizeOptionalString } from "mo/plugin-sdk/string-coerce-runtime";
import type {
  GeneratedVideoAsset,
  VideoGenerationProvider,
  VideoGenerationRequest,
  VideoGenerationSourceAsset,
} from "mo/plugin-sdk/video-generation";
...
const SUPPORTED_DURATIONS_HINT = Symbol.for("mo.videoGeneration.supportedDurations");
