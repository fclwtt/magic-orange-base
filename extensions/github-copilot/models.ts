...
import { buildCopilotIdeHeaders, COPILOT_INTEGRATION_ID } from "mo/plugin-sdk/provider-auth";
import { readProviderJsonArrayFieldResponse } from "mo/plugin-sdk/provider-http";
...
export function resolveCopilotForwardCompatModel(
  ...
  // by simply adding them to agents.defaults.models in mo.json — no
