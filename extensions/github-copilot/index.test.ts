...
import { MAX_DATE_TIMESTAMP_MS, MAX_TIMER_TIMEOUT_MS } from "mo/plugin-sdk/number-runtime";
import type {
  OpenClawConfig,
  OpenClawPluginApi,
  ProviderAuthResult,
...
async function createAgentDir() {
  const dir = await fs.mkdtemp(path.join(os.tmpdir(), "mo-github-copilot-test-"));
  tempDirs.push(dir);
  return dir;
}
