...
import type { DiscordGuildEntry, OpenClawConfig } from "mo/plugin-sdk/config-contracts";
import type { ChannelSetupDmPolicy, ChannelSetupWizard } from "mo/plugin-sdk/setup-runtime";
import {
  createSetupTranslator,
  createStandardChannelSetupStatus,
} from "mo/plugin-sdk/setup-runtime";
import { formatDocsLink } from "mo/plugin-sdk/setup-tools";
