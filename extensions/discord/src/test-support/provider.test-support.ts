...
import type { RuntimeEnv } from "mo/plugin-sdk/runtime-env";
...
vi.mock("mo/plugin-sdk/acp-runtime", async () => {
  const actual = await vi.importActual<typeof import("mo/plugin-sdk/acp-runtime")>(
    "mo/plugin-sdk/acp-runtime",
  );
  return {
    ...actual,
...
vi.mock("mo/plugin-sdk/native-command-config-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("mo/plugin-sdk/native-command-config-runtime")
  >("mo/plugin-sdk/native-command-config-runtime");
  return {
    ...actual,
...
vi.mock("mo/plugin-sdk/error-runtime", async () => {
  const actual = await vi.importActual<typeof import("mo/plugin-sdk/error-runtime")>(
    "mo/plugin-sdk/error-runtime",
  );
  return {
    ...actual,
