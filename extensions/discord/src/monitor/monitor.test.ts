...
import { buildPluginBindingApprovalCustomId } from "mo/plugin-sdk/conversation-runtime";
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/mo-sessions-test.json");
