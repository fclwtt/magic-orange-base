...
import type { ModelsProviderData } from "mo/plugin-sdk/models-provider-runtime";
import { parseStrictInteger, parseStrictPositiveInteger } from "mo/plugin-sdk/number-runtime";
...
let modelsProviderRuntimePromise:
  | Promise<typeof import("mo/plugin-sdk/models-provider-runtime")>
  | undefined;

async function loadModelsProviderRuntime() {
  modelsProviderRuntimePromise ??= import("mo/plugin-sdk/models-provider-runtime");
