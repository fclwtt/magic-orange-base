...
import { createPluginRuntimeMock } from "mo/plugin-sdk/channel-test-helpers";
...
let runtimeEnvModule: typeof import("mo/plugin-sdk/runtime-env");
...
describe("monitorDiscordProvider", () => {
  ...
  beforeAll(async () => {
    vi.doMock("mo/plugin-sdk/plugin-runtime", async () => {
    ...
    runtimeEnvModule = await import("mo/plugin-sdk/runtime-env");
