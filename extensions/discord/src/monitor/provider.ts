import { loadModelCatalog } from "mo/plugin-sdk/agent-runtime";
...
import type { OpenClawConfig, ReplyToMode } from "mo/plugin-sdk/config-contracts";
import { createConnectedChannelStatusPatch } from "mo/plugin-sdk/gateway-runtime";
import {
  resolveNativeCommandsEnabled,
  resolveNativeSkillsEnabled,
} from "mo/plugin-sdk/native-command-config-runtime";
import { resolveTextChunkLimit } from "mo/plugin-sdk/reply-chunking";
import { getRuntimeConfig } from "mo/plugin-sdk/runtime-config-snapshot";
import { isVerbose, logVerbose, shouldLogVerbose, warn } from "mo/plugin-sdk/runtime-env";
import { createSubsystemLogger } from "mo/plugin-sdk/runtime-env";
import { createNonExitingRuntime, type RuntimeEnv } from "mo/plugin-sdk/runtime-env";
import {
...
import { formatErrorMessage } from "mo/plugin-sdk/ssrf-runtime";
import {
...
export async function monitorDiscordProvider(opts: MonitorDiscordOpts = {}) {
  ...
  try {
    ...
    const guildHistories = new Map<
      string,
      import("mo/plugin-sdk/reply-history").HistoryEntry[]
    >();
