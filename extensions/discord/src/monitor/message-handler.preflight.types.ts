...
import type { InboundEventKind } from "mo/plugin-sdk/channel-inbound";
...
import type { SessionBindingRecord } from "mo/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "mo/plugin-sdk/reply-history";
import type { resolveAgentRoute } from "mo/plugin-sdk/routing";
...
export type RuntimeEnv = import("mo/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("mo/plugin-sdk/config-contracts").OpenClawConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
