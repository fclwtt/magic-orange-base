...
import type { ChatCommandDefinition, CommandArgs } from "mo/plugin-sdk/command-auth-native";
...
import { patchSessionEntry, resolveStorePath } from "mo/plugin-sdk/session-store-runtime";
import { withTimeout } from "mo/plugin-sdk/text-utility-runtime";
