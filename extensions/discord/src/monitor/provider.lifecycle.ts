...
} from "mo/plugin-sdk/gateway-runtime";
import { asDateTimestampMs, parseStrictPositiveInteger } from "mo/plugin-sdk/number-runtime";
...
const DISCORD_GATEWAY_READY_TIMEOUT_ENV = "MO_DISCORD_READY_TIMEOUT_MS";
const DISCORD_GATEWAY_RUNTIME_READY_TIMEOUT_ENV = "MO_DISCORD_RUNTIME_READY_TIMEOUT_MS";
