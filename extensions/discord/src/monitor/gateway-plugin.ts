...
import type { DiscordAccountConfig } from "mo/plugin-sdk/config-contracts";
import { createNodeProxyAgent } from "mo/plugin-sdk/fetch-runtime";
import {
  captureWsEvent,
...
type ResolveDiscordGatewayIntentsParams = {
  intentsConfig?: import("mo/plugin-sdk/config-contracts").DiscordIntentsConfig;
