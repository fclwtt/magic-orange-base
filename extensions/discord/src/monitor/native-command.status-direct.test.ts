...
vi.mock("mo/plugin-sdk/reply-dispatch-runtime", async () => {
  const actual = await vi.importActual<typeof import("mo/plugin-sdk/reply-dispatch-runtime")>(
    "mo/plugin-sdk/reply-dispatch-runtime",
  );
  return {
    ...actual,
...
vi.mock("mo/plugin-sdk/command-status-runtime", () => ({
...
describe("discord native /status", () => {
  ...
  beforeEach(() => {
    ...
    discordNativeCommandTesting.setDispatchReplyWithDispatcher(
      runtimeModuleMocks.dispatchReplyWithDispatcher as typeof import("mo/plugin-sdk/reply-dispatch-runtime").dispatchReplyWithDispatcher,
    );
    discordNativeCommandTesting.setMatchPluginCommand(
      (() => null) as typeof import("mo/plugin-sdk/plugin-runtime").matchPluginCommand,
    );
  ...
  it("prioritizes direct status replies over matching plugin commands", async () => {
    ...
    discordNativeCommandTesting.setMatchPluginCommand((() => ({
      ...
      args: undefined,
    })) as typeof import("mo/plugin-sdk/plugin-runtime").matchPluginCommand);
    discordNativeCommandTesting.setExecutePluginCommand(
      executePluginCommand as typeof import("mo/plugin-sdk/plugin-runtime").executePluginCommand,
    );
    const cfg = createConfig();
    const command = await createStatusCommand(cfg);
    const interaction = createInteraction();
