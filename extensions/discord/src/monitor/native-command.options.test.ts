...
let listNativeCommandSpecs: typeof import("mo/plugin-sdk/command-auth-native").listNativeCommandSpecs;
...
describe("createDiscordNativeCommand option wiring", () => {
  beforeAll(async () => {
    ({ listNativeCommandSpecs } = await import("mo/plugin-sdk/command-auth-native"));
