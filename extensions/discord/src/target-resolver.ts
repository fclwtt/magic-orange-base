...
import { buildMessagingTarget, type MessagingTarget } from "mo/plugin-sdk/channel-targets";
import type { DirectoryConfigParams } from "mo/plugin-sdk/directory-runtime";
