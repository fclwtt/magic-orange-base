...
// Deprecated compatibility surface for existing @mo/discord/api.js consumers.
...
export { resolveOpenProviderRuntimeGroupPolicy as resolveDiscordRuntimeGroupPolicy } from "mo/plugin-sdk/runtime-group-policy";
