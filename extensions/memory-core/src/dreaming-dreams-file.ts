...
import { extractErrorCode } from "mo/plugin-sdk/error-runtime";
import { resolveGlobalMap } from "mo/plugin-sdk/global-singleton";
import { replaceManagedMarkdownBlock } from "mo/plugin-sdk/memory-host-markdown";
import { readRegularFile, replaceFileAtomic } from "mo/plugin-sdk/security-runtime";

const DREAMS_FILENAMES = ["DREAMS.md", "dreams.md"] as const;
const DEEP_START_MARKER = "<!-- mo:dreaming:deep:start -->";
const DEEP_END_MARKER = "<!-- mo:dreaming:deep:end -->";
