...
import {
  ...
  type OpenClawConfig,
} from "mo/plugin-sdk/memory-core-host-runtime-core";
import type {
  MemorySearchResult,
  MemorySearchRuntimeDebug,
} from "mo/plugin-sdk/memory-core-host-runtime-files";
import {
...
const PAUSED_MEMORY_INDEX_ACTION =
  "Tell the user to run: mo memory status --index or mo memory index --force.";
