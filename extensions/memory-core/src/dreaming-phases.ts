...
import type { MemorySearchResult } from "mo/plugin-sdk/memory-core-host-runtime-files";
import {
...
import type { OpenClawPluginApi } from "mo/plugin-sdk/plugin-entry";
...
const LIGHT_SLEEP_EVENT_TEXT = "__mo_memory_core_light_sleep__";
const REM_SLEEP_EVENT_TEXT = "__mo_memory_core_rem_sleep__";
...
const MANAGED_DAILY_DREAMING_BLOCKS = [
  {
    heading: "## Light Sleep",
    startMarker: "<!-- mo:dreaming:light:start -->",
    endMarker: "<!-- mo:dreaming:light:end -->",
  },
  {
    heading: "## REM Sleep",
    startMarker: "<!-- mo:dreaming:rem:start -->",
    endMarker: "<!-- mo:dreaming:rem:end -->",
  },
] as const;
