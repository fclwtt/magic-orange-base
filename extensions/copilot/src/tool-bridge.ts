...
import { createAgentHarnessToolSurfaceRuntime } from "mo/plugin-sdk/agent-harness-tool-runtime";
 ...
 * `mo/plugin-sdk/agent-harness-runtime` boundary, *not* from
...
export async function createCopilotToolBridge(
  ...
  const createOpenClawCodingTools =
    ...
    (await import("mo/plugin-sdk/agent-harness")).createOpenClawCodingTools;
