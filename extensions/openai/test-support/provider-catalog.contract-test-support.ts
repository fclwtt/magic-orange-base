...
import type { ProviderPlugin } from "mo/plugin-sdk/provider-test-contracts";
...
vi.mock("mo/plugin-sdk/provider-catalog-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("mo/plugin-sdk/provider-catalog-runtime")
  >("mo/plugin-sdk/provider-catalog-runtime");
