...
} from "mo/plugin-sdk/image-generation";
import {
  parseOpenAiCompatibleImageResponse,
  resolveInlineImageJsonResponseMaxBytes,
  toImageDataUrl,
} from "mo/plugin-sdk/image-generation";
import { createSubsystemLogger } from "mo/plugin-sdk/logging-core";
import { resolveClosestSize } from "mo/plugin-sdk/media-generation-runtime";
import { extensionForMime } from "mo/plugin-sdk/media-mime";
import { MAX_IMAGE_BYTES } from "mo/plugin-sdk/media-runtime";
import {
...
function shouldAllowPrivateImageEndpoint(req: {
  ...
  return process.env.MO_QA_ALLOW_LOCAL_IMAGE_PROVIDER === "1";
}
