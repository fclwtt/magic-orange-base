...
import type { FixedWindowRateLimiter } from "mo/plugin-sdk/webhook-ingress";
...
vi.mock("mo/plugin-sdk/webhook-request-guards", () => ({
  readJsonWebhookBodyOrReject,
}));

vi.mock("mo/plugin-sdk/webhook-targets", () => ({
...
describe("googlechat monitor webhook", () => {
  ...
  afterAll(() => {
    vi.doUnmock("mo/plugin-sdk/webhook-request-guards");
    vi.doUnmock("mo/plugin-sdk/webhook-targets");
    vi.doUnmock("./auth.js");
    vi.resetModules();
  });
