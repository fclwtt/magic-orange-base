...
import { buildChannelConfigSchema } from "mo/plugin-sdk/channel-config-schema";
import { createChatChannelPlugin } from "mo/plugin-sdk/channel-core";
import {
  createLoggedPairingApprovalNotifier,
  createPairingPrefixStripper,
} from "mo/plugin-sdk/channel-pairing";
    ...
    base: {
      ...
      resolver: {
        resolveTargets: async ({
          ...
          runtime: import("mo/plugin-sdk/runtime-env").RuntimeEnv;
