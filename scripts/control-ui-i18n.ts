...
import { completeSimple, type AssistantMessage, type Model } from "mo/plugin-sdk/llm";
...
const ENV_PROVIDER = "MO_CONTROL_UI_I18N_PROVIDER";
const ENV_MODEL = "MO_CONTROL_UI_I18N_MODEL";
const ENV_THINKING = "MO_CONTROL_UI_I18N_THINKING";
const ENV_BATCH_CHAR_BUDGET = "MO_CONTROL_UI_I18N_BATCH_CHAR_BUDGET";
const ENV_PROMPT_TIMEOUT = "MO_CONTROL_UI_I18N_PROMPT_TIMEOUT";
const ENV_AUTH_OPTIONAL = "MO_CONTROL_UI_I18N_AUTH_OPTIONAL";
