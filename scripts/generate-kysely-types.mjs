...
const SCHEMAS = [
  {
    name: "mo-state",
    schema: "src/state/mo-state-schema.sql",
    outFile: "src/state/mo-state-db.generated.d.ts",
    schemaOutFile: "src/state/mo-state-schema.generated.ts",
    schemaExport: "MO_STATE_SCHEMA_SQL",
  },
  {
    name: "mo-agent",
    schema: "src/state/mo-agent-schema.sql",
    outFile: "src/state/mo-agent-db.generated.d.ts",
    schemaOutFile: "src/state/mo-agent-schema.generated.ts",
    schemaExport: "MO_AGENT_SCHEMA_SQL",
  },
];
