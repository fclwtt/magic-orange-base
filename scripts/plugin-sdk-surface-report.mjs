...
try {
  budgets = {
    publicEntrypoints: readBudgetEnv("MO_PLUGIN_SDK_MAX_PUBLIC_ENTRYPOINTS", 322),
    publicExports: readBudgetEnv("MO_PLUGIN_SDK_MAX_PUBLIC_EXPORTS", 10405),
    publicFunctionExports: readBudgetEnv("MO_PLUGIN_SDK_MAX_PUBLIC_FUNCTION_EXPORTS", 5223),
    publicDeprecatedExports: readBudgetEnv(
      "MO_PLUGIN_SDK_MAX_PUBLIC_DEPRECATED_EXPORTS",
      3261,
    ),
    publicWildcardReexports: readBudgetEnv(
      "MO_PLUGIN_SDK_MAX_PUBLIC_WILDCARD_REEXPORTS",
      214,
    ),
  };
  publicDeprecatedExportsByEntrypointBudget = readEntrypointBudgetEnv(
    "MO_PLUGIN_SDK_MAX_PUBLIC_DEPRECATED_EXPORTS_BY_ENTRYPOINT",
