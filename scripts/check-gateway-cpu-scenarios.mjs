  ...
  return {
    ...
    ...(qaState
      ? {
          ...
          MO_HOME: qaState.home,
          MO_STATE_DIR: qaState.stateDir,
          MO_CONFIG_PATH: qaState.configPath,
        }
      : {}),
    MO_BUILD_PRIVATE_QA: "1",
    MO_ENABLE_PRIVATE_QA_CLI: "1",
    MO_RUN_NODE_SKIP_DTS_BUILD: env.MO_RUN_NODE_SKIP_DTS_BUILD ?? "1",
    MO_TEST_DISABLE_UPDATE_CHECK: env.MO_TEST_DISABLE_UPDATE_CHECK ?? "1",
